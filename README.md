...
The docker on first run will download the same version as tagged of FTB Presents Stoneblock 2 and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "FTB Presents Stoneblock 2 Server Powered by Docker"
* LEVEL 
...
## Source
Github: https://github.com/Goobaroo/docker-stoneblock2

Docker: https://hub.docker.com/repository/docker/goobaroo/stoneblock2